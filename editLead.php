...
<!-- .................................... $breadcrumb .................................... -->
  <section class="section-breadcrumb section-color-graylighter" style="padding-top: 75px; padding-bottom: 10px;">
    <div class="container">
	  ...
	  <a href='imagesLead.php?id=<?php echo $Id?>'>
      	<button type="button" class="btn-main"><i class="fa fa-file-image-o" aria-hidden="true"></i> images </button>
      </a>
				...
				<div class="panel-heading">					
                    <div class="control-group-inline" style="padding-top: 10px;">		  		
                        ...
                        VillaId <input name="villaId" type="text" class="span4" id="villaId"  maxlength="3" placeholder="villaId" style="width: 10%;" value="<?php echo $villaId ?>">           
                      	&nbsp;	&nbsp; 
                        Submitted from <input name="tipo" type="text" class="span4" id="tipo"  maxlength="10" placeholder="" style="width: 10%;" value="<?php echo $tipo ?>">           
                      	&nbsp;	&nbsp;                        
                    </div>
                    <div class="control-group-inline" style="padding-top: 10px;">	 
                        Notes <input class="span4" id="Notes" name="Notes" placeholder="Notes" type="text" maxlength="160" style="width: 90%;"  value="<?php echo $notes?>">           
                    </div>                     
				</div>				
		</div>
	</div>
